...
cp $WORKING_PATH/analysis/others/for_btv/*UL18*.csv $CMSSW_BASE/src/PhysicsTools/NanoAODTools/data/btagSF/
...
rm -r $CMSSW_BASE/src/PhysicsTools/NanoAODTools/data/jme/*UL17*.tgz
